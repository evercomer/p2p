...
#define CMD_TALKBACK		0x116
//req: byte0: media type, byte1~n: audio data
//resp: none

#define CMD_STOP_TALKBACK		0x117 
//stop Talkback

#define CMD_GET_POWER_FREQ	0x118
//req: int32_t vchn;
//resp: int32_t freq;	//POWERFREQ_xxx

#define CMD_SET_POWER_FREQ	0x119
//req: struct CmdSetPowerFreqReq
//resp:

#define CMD_GET_VIDEO_PARAMETER		0x11A	/// Get
//req: int32_t chno
//resp: struct dcs_video_param
#define CMD_SET_VIDEO_PARAMETER		0x11B	/// Set brmode/bps/fps/quality...
//req: 	struct CmdSetVideoParameterReq
//resp:

#define CMD_SNAPSHOT		0x11C
//req: struct CmdSnapshotReq
//resp: ushort end_flag;
//      ushort reserved;
//      char data[0];

#define CMD_DOWNLOAD_FILE	0x11D
...
#define CMD_LIST_WIFI_AP	0x11E
//req:
//resp: struct CmdListWifiApResp

#define CMD_GET_WIFI	0x11F
//req:
//resp: struct WifiSettng

#define CMD_SET_WIFI	0x120
//req: struct WifiSetting
//resp:

#define CMD_GET_FLIP	0x121
//req: int32_t vchn;
//resp: int32_t flips;	//combine of VIDEOFLIP_HORZ and VIDEOFLIP_VERT

#define CMD_SET_FLIP	0x122
//req: CmdSetFlipReq
//resp:

#define CMD_CHANGE_PSWD	0x123
//req: char *new_pswd;
//resp:

#define CMD_GET_TIME 0x124
//req:	
//resp: struct DATimeInfo

#define CMD_SET_TIME 0x125
